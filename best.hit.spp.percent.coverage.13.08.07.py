...
for line in blast_report_in:
	...
	#compare coverage_score to the coverage score recorded in all_coverage_dict for query_id. if coverage_score is >=, add the subjectID to the list of outputs (if it is not already in the list)
