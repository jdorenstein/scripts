...
dQhS_path = '/Users/ionchannel/research/tools/db/blast/13.proteomes/000.origional.docs/top.hits.coverage.13.08.06/out.topHits.drosophilaQ.homoS.coverage'
dQcS_path = '/Users/ionchannel/research/tools/db/blast/13.proteomes/000.origional.docs/top.hits.coverage.13.08.06/out.topHits.drosophilaQ.caenorhabditisS.coverage'


###IOout###
##the main output file
  #frmt: (hsa gene) (dr/ce gene) (% coverage)
conversion_out = open('/Users/ionchannel/research/tools/db/blast/13.proteomes/000.origional.docs/least.coverage.13.08.06/dr.least.coverage.conversion.13.08.06' ,'a')
##the averages file
  #frmt: (dr 1,2,3,4) \n (ce 1,2,3,4)  
averages_out = open('/Users/ionchannel/research/tools/db/blast/13.proteomes/000.origional.docs/least.coverage.13.08.06/dr.least.coverage.conversion.13.08.06.averages' ,'a')
##the distribution file
   #frmt: #drosophila \n [0] [frequency] \n [5] [frequency] ... #celegans ...
distr_out = open('/Users/ionchannel/research/tools/db/blast/13.proteomes/000.origional.docs/least.coverage.13.08.06/dr.least.coverage.conversion.13.08.06.distribution','a') 
no_hits_out = open('/Users/ionchannel/research/tools/db/blast/13.proteomes/000.origional.docs/least.coverage.13.08.06/dr.least.coverage.conversion.13.08.06.noHits' ,'a')
...
hsa_proteome_path = '/Users/ionchannel/13.PROTEOMES.PATH/000.origional.docs/proteome.drosophila.melanogaster.longest.peptide.fa'
...
dr_cov_pep = 0.0
ce_cov_pep = 0.0
dr_cov_pep = sum_percent_cov(dqhs_dict) / 13937.0
ce_cov_pep = sum_percent_cov(dqcs_dict) / 13937.0
##avg_cov * nohit/total
dr_cov_nohit = 0.0
ce_cov_nohit = 0.0

nohit_total = 3379.0 / 13937.0
