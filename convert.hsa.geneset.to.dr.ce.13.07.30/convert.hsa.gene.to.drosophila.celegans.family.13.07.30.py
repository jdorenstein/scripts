...
cgs_gene_list_path = '/Users/ionchannel/research/projects/ionchannels/' + which_dir + '/geneset/candidate.genesets.gene.list'
...
drosophila_gene_path = '/Users/ionchannel/research/projects/ionchannels/' + which_dir + '/geneset/candidate.geneset.gene.dr.list'
celegans_gene_path = '/Users/ionchannel/research/projects/ionchannels/' + which_dir + '/geneset/candidate.geneset.gene.ce.list'
hsa_gene_path = '/Users/ionchannel/research/projects/ionchannels/' + which_dir + '/geneset/gene.hsa.drosophila.celegans.conversion'
log_path = '/Users/ionchannel/research/projects/ionchannels/candidate.genesets.db/geneset/drosophila.celegans.number.of.genes.family.txt'
...
for line in conversion_in:
	...
	if line[0:3] == 'SEQ':
		...
		if lineSplit[1] == 'drosophila_melanogaster':
			if drosophila_list == '':
				drosophila_list = lineSplit[7] + '-' + lineSplit[8][:-1]
			else:
				drosophila_list = drosophila_list + ' ' + lineSplit[7] + '-' + lineSplit[8][:-1]
		if lineSplit[1] == 'caenorhabditis_elegans':
			if celegans_list == '':
				celegans_list = lineSplit[7] + '-' + lineSplit[8][:-1]
			else:
				celegans_list = celegans_list + ' ' + lineSplit[7] + '-' + lineSplit[8][:-1]
	if line[0:4] == 'DATA':
...
output_dr = which_dir + '\n \n' + 'DROSOPHILA GENES RECORDED: ' + str(drosophila_hits) + '\n'
output_ce = 'CELEGANS GENES RECORDED: ' + str(celegans_hits) + '\n \n \n' + '-----------' + '\n \n \n'

log_out.write(output_dr)
log_out.write(output_ce)
