...
for fileName in os.listdir('/Users/ionchannel/research/tools/db/blast/12.proteomes/000.origional.docs/'): #list the ionchannel folders that the user can enter
	print fileName
...
input_path = '/Users/ionchannel/research/tools/db/blast/12.proteomes/000.origional.docs/' + input_name
output_path = '/Users/ionchannel/research/tools/db/blast/12.proteomes/000.origional.docs/' + output_name
###IOin###
#nothing to import
###IOout###
